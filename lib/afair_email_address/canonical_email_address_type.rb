...
#                                AfairEmailAddress::CanonicalEmailAddressType)
#
...
class AfairEmailAddress::CanonicalEmailAddressType < ActiveRecord::Type::Value

  # From user input, setter
  def cast(value)
    super(AfairEmailAddress.canonical(value))
  end
